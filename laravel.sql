...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=421629368ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=products">`laravel`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=users">`laravel`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=product">`laravel`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=carts">`laravel`.`carts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=cart">`laravel`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=user">`laravel`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=category">`laravel`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=product">`test`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=doctrine_migration_versions">`test`.`doctrine_migration_versions`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2a4c4a30626b74302d4254774b7d6237">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Нажмите Enter для выполнения запроса                    </span>
                            ...
                            targetdb="laravel" targettable="users">
            ...
            Запрошенное время
                            ...
                            <span class="query">INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `role`, `remember_token`, `created_at`, `updated_at`) VALUES (NULL, &#039;qwe&#039;, &#039;qwe@mail.ru&#039;, NULL, &#039;qwerqwt&#039;, &#039;0&#039;, NULL, NULL, NULL);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="laravel" targettable="users">
                            <div class="action_content">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="laravel" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
